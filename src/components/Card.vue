<template>
  <div class="card">
    ...
    <div v-if="mold === 'quote'" class="article-card">
      <div class="title">豆瓣App 5.22.0 主要更新</div>
      <div class="detail">
        - 可以进行精心设计表白程序，向心仪的心上人说出自己。对着她说’我爱你“‘...
      </div>
    </div>
    <p v-if="mold === 'comment'" class="comment">
      - 谢谢老板~~~，请吃糖啊~ 请吃糖就是老板哈哈哈...
    </p>
    <div class="info">
      <span class="btn like"><i>5</i></span>
      <span v-if="mold === 'quote'" class="btn comment"><i>2</i></span>
      <span v-if="mold === 'quote'" class="btn retweet"><i>2</i></span>
