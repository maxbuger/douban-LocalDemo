    ...
    <template v-if="!showLoading">
      <div class="subject-card">
        ...
        <div class="subject-info">
          <div class="right">
            <a href="#">
              <img alt="" v-if="subject.images" :src="subject.images.large">
            </a>
          </div>
          <div class="left" v-if="subject.rating">
            <rating :rating="subject.rating">
              <span slot="ratingsContent">{{subject.ratings_count}}人评价</span>
            </rating>
        ...
        <div v-if="subject.author" class="vendors-link">
          <a class="link">在哪儿买这本书？
            <span class="info">豆瓣阅读电子书 0.06元起</span>
          </a>
        </div>
        <marking>
        ...
        <div class="subject-pics">
          ...
          <ul v-if="subject.images">
            <li class="pic">
              <a href="#">
                <img alt="poster" :src="subject.images.large">
              </a>
            </li>
            <li class="pic">
              <a href="#">
        ...
        <div class="subject-catalog">
          ...
          <p>
            <template v-if="catalog && subject.catalog">
              {{isExpand ? catalog : subject.catalog}}……
            </template>
            <a href="javascript:;" v-show="isExpand" v-on:click="expand">
              (展开)
            </a>
      ...
      <div class="subject-question">
        <h2>关于{{subject.title}}</h2>
        <list :items="questions"></list>
        <a href="javascript:;" class="list-link">显示更多问答</a>
      </div>
      <scroller title="更多推荐 " type="onlyString" :items="bookTags" slot="book" v-if="subject.author"></scroller>
      <scroller title="更多推荐 " type="onlyString" :items="movieTags" slot="movie" v-else></scroller>
